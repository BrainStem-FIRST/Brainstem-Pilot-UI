          ...
          <div className="max-w-2xl mx-auto px-6 py-8">
            ...
            <Section id="setup" title="Initial Setup" subtitle="Connect BrainSTEM Pilot to your robot project" icon={FolderOpen}>
              ...
              <ol className="list-decimal ml-5 space-y-3 text-sm">
                ...
                <li>Default files are created: <code className="text-xs font-num bg-secondary px-1 rounded">robot_settings.json</code>, <code className="text-xs font-num bg-secondary px-1 rounded">app_settings.json</code>, <code className="text-xs font-num bg-secondary px-1 rounded">subsystem_config.json</code>, and the <code className="text-xs font-num bg-secondary px-1 rounded">paths/</code>, <code className="text-xs font-num bg-secondary px-1 rounded">points/</code> and <code className="text-xs font-num bg-secondary px-1 rounded">autos/</code> folders as you save into them. On FTC, <code className="text-xs font-num bg-secondary px-1 rounded">PilotAutoBase.java</code> is created once in the project folder and is not overwritten after that.</li>
            ...
            <Section id="ftc" title="FTC Specifics" subtitle="OpModes, assets, and inches" icon={Cpu}>
              <ul className="list-disc ml-5 space-y-1.5 text-sm">
                ...
                <li><strong>Robot wiring</strong> — the first FTC open or Auto save also writes <code className="font-num bg-secondary px-1 rounded">PilotAutoBase.java</code> next to the JSON. Edit that file to hook up your robot, drive, and subsystem commands. The UI will not overwrite it after creating it.</li>
